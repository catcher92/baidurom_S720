...
.method static synthetic access$2600(Lcom/android/server/ConnectivityService;ZILandroid/app/Notification;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3100(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Vpn;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3800(Lcom/android/server/ConnectivityService;Ljava/lang/Long;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4000(Lcom/android/server/ConnectivityService;ZZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    aget-object v23, v27, v24

    .line 1736
    .local v23, pids:Ljava/util/List;
    const/4 v8, 0x0
    ...
    .end local v23           #pids:Ljava/util/List;
    :cond_0
    ...
    .line 1762
    .local v21, optr:Ljava/lang/String;
    ...
    .end local v21           #optr:Ljava/lang/String;
    ...
    .line 1809
    invoke-static/range {v25 .. v25}, Landroid/net/ConnectivityManager;->isRadioNumValid(I)Z
    ...
    .restart local v21       #optr:Ljava/lang/String;
    :cond_8
    const/16 v27, 0x0
    ...
    .line 1786
    .local v16, mgr:Landroid/net/wifi/WifiManager;
    invoke-virtual/range {v16 .. v16}, Landroid/net/wifi/WifiManager;->hasConnectableAP()Z
    ...
    .line 1797
    .restart local v26       #switchTo:Landroid/net/NetworkInfo;
    const-string v27, "otherNetwork"
    ...
    .end local v16           #mgr:Landroid/net/wifi/WifiManager;
    .end local v17           #mobileData:Z
    .end local v21           #optr:Ljava/lang/String;
    ...
    .line 1824
    .local v13, l:Landroid/net/LinkProperties;
    if-eqz v13, :cond_7
    ...
    .end local v3           #arr$:[Landroid/net/NetworkStateTracker;
    .end local v9           #i$:I
    .end local v13           #l:Landroid/net/LinkProperties;
    .end local v14           #len$:I
...
.method private handleMobileDataConnectionChange(Ljava/lang/Long;)V
    ...
    invoke-static/range {v16 .. v19}, Landroid/provider/Settings$System;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    invoke-interface/range {v16 .. v18}, Landroid/net/INetworkPolicyManager;->isDataConnOverLimit(J)Z
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/ConnectivityService;->buildSimOverLimitIntent(J)Landroid/content/Intent;
    ...
    invoke-static/range {v16 .. v18}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I

    move-result v13

    .line 3756
    .local v13, preSimSlot:I
    :try_start_1
    const-string v16, "CDS/Srv"
    ...
    .line 3771
    invoke-interface {v7, v3, v13}, Lcom/android/internal/telephony/ITelephony;->cleanupApnTypeGemini(Ljava/lang/String;I)I
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-interface {v7, v0, v15}, Lcom/android/internal/telephony/ITelephony;->enableApnTypeGemini(Ljava/lang/String;I)I
