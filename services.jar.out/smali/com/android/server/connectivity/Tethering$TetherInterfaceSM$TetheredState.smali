...
.method public processMessage(Landroid/os/Message;)Z
    ...
    const-string v8, "[ISM_Tethered] processMessage what="
    ...
    const-string v7, "[ISM_Tethered] mMyUpstreamIfaceName: "
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$2300(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;
    ...
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    ...
    invoke-static {v5, v9}, Lcom/android/server/connectivity/Tethering;->access$800(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v11}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1200(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mInitialState:Lcom/android/internal/util/State;
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1700(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;
    ...
    const-string v7, "[ISM_Tethered] Untethered "
    ...
    const-string v8, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED mMyUpstreamIfaceName: "
    ...
    const-string v6, "[ISM_Tethered] Connection changed noop - dropping"
    ...
    invoke-static {v5, v9}, Lcom/android/server/connectivity/Tethering;->access$2802(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    const-string v8, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED enableNat("
    ...
    const-string v7, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED updateDns"
    ...
    invoke-static {v7}, Lcom/android/server/connectivity/Tethering;->access$3000(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;

    move-result-object v7

    invoke-interface {v5, v7}, Landroid/os/INetworkManagementService;->setDnsForwarders([Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string v7, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED finished"
    ...
    #setter for: Lcom/android/server/connectivity/Tethering;->mIsTetheringChangeDone:Z
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering;->access$2802(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    const-string v8, "[ISM_Tethered] Exception enabling Nat: "
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v7}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1200(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v7}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    const-string v8, "[ISM_Tethered] untetherInterface failed, exception: "
    ...
    const-string v7, "[ISM_Tethered] CMD_TETHER_MODE_DEAD, mMyUpstreamIfaceName: "
    ...
    const-string v7, "[ISM_Tethered] Tether lost upstream connection "
    ...
    const-string v6, "[ISM_Tethered] sendTetherStateChangedBroadcast in CMD_TETHER_MODE_DEAD of TetheredState"
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3200(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
