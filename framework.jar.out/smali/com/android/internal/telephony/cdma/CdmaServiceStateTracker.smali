...
.method public constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 151
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mAutoTimeChanged:Z

    .line 154
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->currentCarrier:Ljava/lang/String;

    .line 155
    iput v2, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->cdmaConnType:I
    ...
    invoke-direct {v4, v5}, Landroid/telephony/ServiceState;-><init>(I)V
    ...
    invoke-direct {v4, v5}, Landroid/telephony/SignalStrength;-><init>(I)V
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getMySimId()I
    ...
    :cond_6
    const-string v33, "[NITZ] mSimId = Phone.GEMINI_SIM_2"
    ...
    .line 1383
    const-string v33, "gsm.operator.iso-country.2"
    ...
    const-string v34, "NITZ:millisSinceNitzReceived = "
    ...
    const-string v34, "NITZ:before ===== modify zone c.getTimeInMillis() = "
    ...
    const-string v34, "NITZ: (int)(-1)*tzOffset = "
    ...
    const-string v34, "NITZ:after ====== modify zone c.getTimeInMillis() = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .end local v9           #ar:Landroid/os/AsyncResult;
    :pswitch_d
    const-string v3, "EVENT_RUIM_RECORDS_LOADED getCDMASubscription"
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    const-string v19, "RIL_REQUEST_OPERATOR.opNames[0] = "
    ...
    const-string/jumbo v19, "opNames[2]"
...
.method protected pollStateDone()V
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telephony/ServiceState;->getRegState()I
    ...
    .line 960
    .local v12, hasRegStateChanged:Z
    :goto_a
    new-instance v21, Ljava/lang/StringBuilder;

    invoke-direct/range {v21 .. v21}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "pollStateDone: hasRegStateChanged = "
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getMySimId()I
    ...
    invoke-static/range {v23 .. v23}, Landroid/telephony/ServiceState;->radioTechnologyToString(I)Ljava/lang/String;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/CommandsInterface$RadioState;->isNVReady()Z
    ...
    invoke-virtual/range {v21 .. v21}, Landroid/telephony/ServiceState;->setStateOff()V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/cdma/CDMAPhone;->updateSimIndicateState()V
    ...
    .end local v12           #hasRegStateChanged:Z
    ...
    .line 993
    .restart local v12       #hasRegStateChanged:Z
    ...
    const-string v22, "gsm.network.type.2"
    ...
    const-string v22, "gsm.operator.alpha.2"
    ...
    const-string v22, "gsm.operator.numeric.2"
    ...
    const-string v23, "gsm.operator.isroaming.2"
    ...
    const-string v22, "gsm.operator.iso-country.2"
...
.method public setCdmaConnType(I)V
    ...
    const-string/jumbo v1, "setCdmaConnType:"
    ...
    iput v0, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mDataConnectionState:I

    .line 1760
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mAttachedRegistrants:Landroid/os/RegistrantList;
    ...
    .line 1763
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mDetachedRegistrants:Landroid/os/RegistrantList;
...
.method protected updateSpnDisplay()V
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getMySimId()I

    move-result v5

    invoke-direct {p0, v5}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isSimInserted(I)Z
    ...
    const-string/jumbo v6, "updateSpnDisplay phone isSimInsert = true"
