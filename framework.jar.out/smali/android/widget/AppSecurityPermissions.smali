...
.method public getPermissionsView()Landroid/view/View;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mInflater:Landroid/view/LayoutInflater;

    .line 212
    iget-object v2, p0, Landroid/widget/AppSecurityPermissions;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mPermsView:Landroid/widget/LinearLayout;

    .line 213
    iget-object v2, p0, Landroid/widget/AppSecurityPermissions;->mPermsView:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMore:Landroid/view/View;

    .line 214
    iget-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMore:Landroid/view/View;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMoreIcon:Landroid/widget/ImageView;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMoreText:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mDangerousList:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mNonDangerousList:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mNoPermsView:Landroid/view/View;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mDefaultGrpLabel:Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mPermFormat:Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mNormalIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mDangerousIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMaxIcon:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroid/widget/AppSecurityPermissions;->mShowMinIcon:Landroid/graphics/drawable/Drawable;
