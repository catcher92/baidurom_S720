...
.method public enter()V
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiConfigStore;->isUsingStaticIp(I)Z
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiStateMachine;->access$2900(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    ...
    const-string v9, " when before start DHCP"
    ...
    iget-object v10, p0, Landroid/net/wifi/WifiStateMachine$ConnectingState;->this$0:Landroid/net/wifi/WifiStateMachine;
    ...
    invoke-static {v7, v8}, Landroid/net/wifi/WifiStateMachine;->access$11702(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpStateMachine;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiConfigStore;->getIpConfiguration(I)Landroid/net/DhcpInfoInternal;
    ...
    iput-object v7, v3, Landroid/net/InterfaceConfiguration;->addr:Landroid/net/LinkAddress;

    .line 3314
    const-string v7, "[up]"

    iput-object v7, v3, Landroid/net/InterfaceConfiguration;->interfaceFlags:Ljava/lang/String;
...
.method public exit()V
    ...
    .prologue
    .line 3398
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$ConnectingState;->this$0:Landroid/net/wifi/WifiStateMachine;

    #getter for: Landroid/net/wifi/WifiStateMachine;->mPowerMode:I
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$13000(Landroid/net/wifi/WifiStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mDhcpStateMachine:Landroid/net/DhcpStateMachine;
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$11700(Landroid/net/wifi/WifiStateMachine;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v3, v1}, Landroid/net/wifi/WifiStateMachine;->access$11800(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpInfoInternal;)V
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v3}, Landroid/net/wifi/WifiStateMachine;->access$12400(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
